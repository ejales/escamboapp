...
####################################################################
  ...
  task generate_admins: :environment do
    ...
    puts "Cadastrando o administradores faker..."
        10.times do
    ...
    puts "Administradores cadastrado....[OK]"
  end
...
####################################################################
  ...
  task generate_comments: :environment do
    ...
    puts "Comentários cadastrados.....[OK]"
  end
